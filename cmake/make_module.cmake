...
function(make_module)
    ...
    get_filename_component(Python3_EXECUTABLE_SUBDIR ${Python3_EXECUTABLE} DIRECTORY)
    module_append_command("prepend-path" "PATH" "HEPPY_DIR" "${Python3_EXECUTABLE_SUBDIR}")
    ...
    file(APPEND ${heppy_module_file} "prepend-path LD_LIBRARY_PATH ${Python3_LIBRARY_DIRS} \n")
    file(APPEND ${heppy_module_file} "prepend-path LD_LIBRARY_PATH ${Python3_RUNTIME_LIBRARY_DIRS} \n")
    file(APPEND ${heppy_module_file} "prepend-path DYLD_LIBRARY_PATH ${Python3_LIBRARY_DIRS} \n")
    file(APPEND ${heppy_module_file} "prepend-path DYLD_LIBRARY_PATH ${Python3_RUNTIME_LIBRARY_DIRS} \n")

    module_append_command_no_prop("setenv" "HEPPY_DIR" "${HEPPY_DIR}" TRUE)
    module_append_command_no_prop("setenv" "HEPPY_PYTHON_EXECUTABLE" "${Python3_EXECUTABLE}" TRUE)
    module_append_command_no_prop("set-alias" "heppython" "\"${Python3_EXECUTABLE}\"" FALSE)
