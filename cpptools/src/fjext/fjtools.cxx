...
namespace FJTools
{
	...
	void NegativeEnergyRecombiner::recombine(const fastjet::PseudoJet & particle1,
		...
		if(combined_particle.E() < 0) {
			...
			combined_particle.reset_momentum(-combined_particle.px(),
												-combined_particle.py(),
												-combined_particle.pz(),
												-combined_particle.E());
		} else { 
