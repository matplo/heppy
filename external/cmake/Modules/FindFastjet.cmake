  ...
  if (EXISTS ${FASTJETCONFIG})
    ...
    if (FASTJET_PYTHON)
      ...
      if (LOAD_FASTJET_PYTHON_ERROR)
        ...
        message(ERROR " ${Red}Loading FastJet python module FAILED:\n ${LOAD_FASTJET_PYTHON_ERROR}${ColourReset}")
      ...
      message(ERROR " ${Red}FastJet python module missing.${ColourReset}")
    endif()  
  else()
    message(ERROR " ${Red}FastJet search requires fastjet-config in \$PATH${ColourReset}")
  endif()
...
if(FASTJET_INCLUDE_DIR AND FASTJET_LIBRARIES)
  ...
  message(ERROR " ${Red}FASTJET not found.${ColourReset}")
endif(FASTJET_INCLUDE_DIR AND FASTJET_LIBRARIES)
